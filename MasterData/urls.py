...
urlpatterns = [
    ...
    path('service_provider_rankings', views.get_service_provider_rankings_page,
         name='get_service_provider_rankings_page'),
    ...
    path('update_service_provider_ranking/<int:item_pk>/', views.update_service_provider_ranking,
         name='update_service_provider_ranking'),
